...
import os
import pandas as pd
from scripts.scraper import scrape_google_reviews
...
def main():
    ...
    try:
        fig = visualize_analysis(df)  # Returns a Matplotlib figure with the pie chart
        st.pyplot(fig)  # Display the figure explicitly
    except Exception as e:
